...
- **PII Protection:** Предварительное маскирование PII перед LLM, валидация отсутствия утечек на выходе
...
- **Метрики:** Prometheus счётчики для JSON errors, PII violations, degradations, TZ issues
